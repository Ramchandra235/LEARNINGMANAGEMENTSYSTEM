    ...
    try {
        ...
        if (studentRs.next()) {
            ...
            String sql = "SELECT a.aid, a.title, a.sub, a.duedate, a.afile, i.instructor_username, " +
                         "(SELECT COUNT(*) FROM submission s WHERE s.aid = a.aid AND s.student_id = ? AND s.submitted_file) AS submitted " +
                         "FROM assignments a " +
...
%>
        <tr>
            ...
            <td>
                <!-- View Button
                <a href="viewstudentsassignments?file=<%= afile %>" target="_blank">
                    <button class="btn view-btn">View</button>
                </a> -->
                <!-- Download Button
                <a href="download_assignment?aid=<%= aid %>&student_id=<%= username %>&file=<%= afile %>">
                      <button class="btn download-btn">Download</button>
                </a> -->
                <form action="download_assignment">
                    ...
                    <button type="submit" class="btn upload-btn">Download</button>
                </form>
